<?php
    ...
    require "cek.php"; // mengecek login apa belum
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">Stock Shop</a>
        <!-- Sidebar Toggle-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning"
                                                href="editkeluar.php?Id_Keluar=<?php echo $data['Id_Keluar']; ?>">Edit</a>

                                            <a class="btn btn-danger"
                                                href="hapuskeluar.php?id=<?php echo $data['Id_Keluar'];?>"
